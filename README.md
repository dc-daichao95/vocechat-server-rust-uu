...
- [x] End-to-end encryption generation 2: authenticated device credentials, Double Ratchet DMs, MLS channels, opaque standard-message delivery, encrypted attachments/backups, and generic notification/webhook payloads.
